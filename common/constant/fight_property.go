// 战斗属性 ID（FightProp 常量集）
//
// 实体的所有战斗数值（HP/攻击/防御/暴击/元素抗性/伤害加成等）
// 与原神官服 FightProperty 枚举完全一致
//
// 命名规则：
//   - BASE_xxx: 基础值（角色等级/突破带来的）
//   - xxx (无前缀): 装备/buff 加成的固定值
//   - xxx_PERCENT: 装备/buff 加成的百分比（0.5=50%）
//   - 最终值 = (BASE_xxx + xxx) × (1 + xxx_PERCENT)
//
// 关键分组：
//   - 1~13: 三维属性（HP/ATK/DEF/SPEED）
//   - 20~29: 暴击/伤害/治疗/能量
//   - 30~39: 元素抗性/伤害加成（火水风雷草冰岩 7 大元素）
//   - 40+:   各元素的基础元素值/能量值
