...
const (
	...
	PLAYER_PROP_PLAYER_HCOIN                    = 10015 // 原石
	...
	PLAYER_PROP_PLAYER_WAIT_SUB_HCOIN           = 10022 // 扣到负数的原石
	PLAYER_PROP_PLAYER_WAIT_SUB_SCOIN           = 10023 // 扣到负数的摩拉
	PLAYER_PROP_IS_ONLY_MP_WITH_PS_PLAYER       = 10024 // 当前玩家多人世界里是否有PS主机玩家 0 1
	PLAYER_PROP_PLAYER_MCOIN                    = 10025 // 创世结晶
	PLAYER_PROP_PLAYER_WAIT_SUB_MCOIN           = 10026 // 扣到负数的创世结晶
	...
	PLAYER_PROP_PLAYER_WAIT_SUB_HOME_COIN       = 10043 // 扣到负数的洞天宝钱
